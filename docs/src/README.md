...
You can find numerous usage examples in the [`examples/`](https://github.com/mosuka/iris/tree/main/examples) directory, covering:

- [Basic Lexical Search](https://github.com/mosuka/iris/blob/main/examples/term_query.rs)
- [Vector Search & Embeddings](https://github.com/mosuka/iris/blob/main/examples/vector_search.rs)
- [Hybrid Search](https://github.com/mosuka/iris/blob/main/examples/hybrid_search.rs)
- [Multimodal Search](https://github.com/mosuka/iris/blob/main/examples/multimodal_search.rs)
